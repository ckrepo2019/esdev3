...
class AccountsReceivableController extends Controller
{
    ...
    public function filter(Request $request)
    {
        ...
        // $students = array();
        //return AccountsReceivableModel::allstudents($selectedschoolyear,$selecteddaterange,$selecteddepartment,$selectedgradelevel,$selectedsemester,$selectedsection,$selectedgrantee,$selectedmode);
