...
<div class="row">
  <div class="col-md-4 ">
      <div class="info-box mb-3 bg-warning" style=" background-image: url('{{asset('dist/img/pic1.jpg')}}'); background-size: cover;">
              ...
              @foreach($complaints as $complaint)
                <li class="todo-list-item">
                  ...
                  @if($complaint->prescription == 'Yes')
                    ...
                    @else
                    <div class="todo-list-item-prescribed" style="margin-left: 23px"><i class="fas fa-check text-success"></i></div>
                    @endif
                  @else
                    <div class="todo-list-item-prescribed" style="margin-left: 23px"><i class="fas fa-times text-danger"></i></div>
                  @endif
        ...
        <ul data-widget="todo-list">
          ...
          @foreach($appointments as $appointment)
            <li class="todo-list-item">
              ...
              <div class="todo-list-item-prescribed" style ="text-align: center"><i class="fas fa-check text-success"></i> <br/> <span class="text-dark" style="text-align: center; font-size: 0.5rem; font-weight: bold"> Physician: Dr. {{$doctorname->lastname}},{{$doctorname->firstname}}&nbsp;{{$doctorname->middlename}} </span></div>
              @else
              <div class="todo-list-item-prescribed" style="margin-left: 23px"><i class="fas fa-times text-danger"></i></div>
              @endif
