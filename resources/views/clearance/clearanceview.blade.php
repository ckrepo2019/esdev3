                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <select class="form-control form-control-sm select2 flex-grow-1" id="filter_clearancehistory"></select>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <p style="font-size:.9rem !important"><span class="font-weight-bold" id="outof"></span></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped table-sm table-bordered table-hover" id="clearance_table" width="100%" style="font-size:11px !important">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $(document).ready(function(){
        ...
        function clearance_table(){
                ...
                columnDefs:[
                    {
                        ...
                        'createdCell': function (td, cellData, rowData, row, col){
                            ...
                            var subdesc = '<label>' + subname +'<br> '+ fullname +'</label><br>' 
                    ...
                    },
                    {
                        ...
                        'createdCell': function (td, cellData, rowData, row, col){
                            ...
                            if(status == 0){
                                badge = '<h6><span class="badge badge-success"><i class="fa fa-check"></i> Cleared</span></h6>'
                                date = rowData.approveddatetime
                            }
                            if(status == 1){
                                badge = '<h6><span class="badge badge-danger"><i class="fa fa-times"></i> Uncleared</span></h6>'
                                date = rowData.updateddatetime
                            }
                            if(status == 2){
                                badge = '<h6><span class="badge badge-warning"><i class="fas fa-hourglass-half"></i> Pending</span></h6>'
                                date = rowData.updateddatetime
                            }
                            if(status == null){
                                badge = '<h6><span class="badge badge-warning"><i class="fas fa-ban"></i> No Clearance</span></h6>'
                                date = null
                            }
                            ...
                            var text = '<span style="font-size:.9rem !important">' + badge + '</span>' 
            ...
            var iscleared = clearance_data && clearance_data[2] && clearance_data[2][0] && clearance_data[2][0].iscleared;
            if(iscleared == 0){
                $("#cleared_status").append('<h3><span class="badge badge-success"><i class="fa fa-check"></i> Clearance Cleared</span></h3>');
            }else if(iscleared == 2){
                $("#cleared_status").append('<h3><span class="badge badge-warning"><i class="fas fa-hourglass-half"></i> Clearance Pending</span></h3>');
            }else{
                $("#cleared_status").append('<h3><span class="badge badge-danger"><i class="fa fa-times"></i> Clearance Uncleared</span></h3>');
            }   
        }
