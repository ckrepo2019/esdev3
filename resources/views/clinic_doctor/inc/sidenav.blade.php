  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 asidebar">
    ...
    <div class="ckheader">
        <a href="#" class="brand-link sidehead">
          ...
          <span class="brand-text font-weight-light" style="position: absolute;top: 50%;font-size: 16px!important;color:#ffc107"><b>SCHOOL DOCTOR</b></span>
        </a>
    </div>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column side" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item">
                    <a href="/clinic/doctor/profile/index"  id="dental" class="nav-link {{Request::url() == url('/clinic/doctor/profile/index') ? 'active' : ''}}">
                        <i class="nav-icon fa fa-user"></i>
                        <p>
                            Doctor Profile
                        </p>
                ...
                <li class="nav-item">
                    <a href="/clinic/doctor/availablity/index"  id="dental" class="nav-link {{Request::url() == url('/clinic/doctor/availablity/index') ? 'active' : ''}}">
                        <i class="nav-icon fa fa-calendar"></i>
                        <p>
                ...
                <li class="nav-item">
                    <a href="/clinic/complaints/index"  id="dental" class="nav-link {{Request::url() == url('/clinic/complaints/index') ? 'active' : ''}}">
                ...
                <li class="nav-item">
                    <a href="/clinic/medicalhistory/index"  id="dental" class="nav-link {{Request::url() == url('/clinic/medicalhistory/index') ? 'active' : ''}}">
