  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 asidebar">
    ...
    <div class="ckheader">
        <a href="#" class="brand-link sidehead">
          ...
          <span class="brand-text font-weight-light" style="position: absolute;top: 50%;font-size: 16px!important;color:#ffc107"><b>NURSE'S PORTAL</b></span>
        </a>
    </div>
    <!-- Sidebar -->
		@php
    ...
    <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column side" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="/clinic/forms/index"  id="dental" class="nav-link {{Request::url() == url('/clinic/forms/index') ? 'active' : ''}}">
