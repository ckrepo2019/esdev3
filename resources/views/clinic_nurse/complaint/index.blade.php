                    ...
                    <div class="card shadow" >
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-2">
                                    <label>&nbsp;</label><br/>
                                    <button type="button" class="btn btn-primary btn-block" id="btn-create"><i class="fa fa-plus"></i> Create</button>
                                </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-5 mb-2">
                        ...
                        <select class="form-control select2" style="width: 100%;" id="addcomplaint-relationship" disabled>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card-body" style="font-size:.8rem !important">
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-info btn-sm" id="btn-approve-prescription"><i class="fa fa-check" aria-hidden="true">Approve</i></button>
                            </div>
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        if(type == "STUDENT"){
                            ...
                            document.getElementById("addcomplaint-relationship").setAttribute("data-id", 1);
                            disabled = 1;
