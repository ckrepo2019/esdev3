...
<html lang="en">
    ...
    * { font-family: Arial, Helvetica, sans-serif; line-height: 11px;}
    @page { margin: 30px 20px 5px 20px; size: {{$papersize != null ? $papersize : '8.5in 13in'}};}/*8.5 13*/
...
<table style="width: 100%;  top: -0.2cm; position: absolute;">
    <tr>
        ...
        <td width="20%" style="text-align:left !important;"  rowspan="5"><span style="float: right; font-weight: bold; font-size: 12px;">SF10-SHS</span><img src="{{base_path()}}/public/assets/images/deped_logo.png" alt="school" width="90px"></td>
    </tr>
    <tr>
