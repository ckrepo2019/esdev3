...
<html lang="en">
    ...
    * { font-family: Arial, Helvetica, sans-serif; }
    @page { margin: 20px 20px 0px 20px;  size: {{$papersize != null ? $papersize : '8.5in 14in'}} ;} /*8.5in 14in*/
...
<div style="width: 100%; line-height: 3px;">&nbsp;</div>
    @if(count($records)>0)
        @foreach($records as $key=>$record)      
                        ...
                        <td colspan="7">
                            ...
                            <table style="width: 100%; font-size: 9px;">
                                <tr>
                                    ...
                                    <td style="width: 5%; border-bottom: 1px solid black;">{{preg_replace('/\D+/', '', $record[0]->levelname)}}</td>
                                    <td style="width: 5%;">Section:</td>
                                    <td style=" border-bottom: 1px solid black;">{{$record[0]->sectionname}}</td>
                                    <td style="width: 7%;">SchoolYear:</td>
                                    <td style="width: 8%; border-bottom: 1px solid black;">{{$record[0]->sydesc}}</td>
                    ...
                    @foreach($record[0]->grades as $grade)
                        @if($record[0]->type == 2)
                            @if(strtolower($grade->subjtitle) != 'general average')
                                <tr @if($key == 0) style="font-size: 10px;" @else style="font-size: 9px;" @endif>
                ...
                @if($record[0]->type == 1)
                    @if(DB::table('schoolinfo')->first()->schoolid == '405308') {{--fmcma--}}
                        <tr style="font-weight: bold; font-size: 9px;">
                            ...
                            <td class="text-center">@if(collect($record[0]->generalaverage)->first()->finalrating > 0){{collect($record[0]->generalaverage)->first()->finalrating >= 75 ? 'PROMOTED' : 'FAILED'}}@endif</td>
                        </tr>
                    @else
                        <tr style="font-weight: bold; font-size: 9px;">
                            <td></td>
                            ...
                            <td class="text-center">
                                @if(isset(collect($record[0]->generalaverage)->first()->finalrating))@if(collect($record[0]->generalaverage)->first()->finalrating > 0){{ collect($record[0]->generalaverage)->first()->finalrating >= 75 ? 'PROMOTED' : 'FAILED'}}@endif @endif
                            </td>
                    ...
                    @foreach(collect($record[0]->remedials)->where('type','1')->values() as $remedial)
                        @if($remedial->type == 2)
                            <tr>
                                ...
                                <td colspan="4">Conducted from (mm/dd/yyyy)&nbsp;&nbsp;{{$remedial->datefrom != null ? date('m/d/Y', strtotime($remedial->datefrom)) : ''}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to  (mm/dd/yyyy)&nbsp;&nbsp;{{$remedial->dateto != null ? date('m/d/Y', strtotime($remedial->dateto)) : ''}}</td>
                            </tr>
                        @endif
                    @endforeach
                @else
                    ...
                    <tr>
                        <td colspan="7">
                            ...
                            <table style="width: 100%; font-size: 9px;">
                                <tr>
                                    <td style="width: 12%;">Classified as Grade:</td>
                                    <td style="width: 5%; border-bottom: 1px solid black;">{{preg_replace('/\D+/', '', $record[1]->levelname)}}</td>
                                    <td style="width: 5%;">Section:</td>
                                    <td style=" border-bottom: 1px solid black;">{{$record[1]->sectionname}}</td>
                                    <td style="width: 7%;">SchoolYear:</td>
                                    <td style="width: 8%; border-bottom: 1px solid black;">{{$record[1]->sydesc}}</td>
                                    <td style="width: 15%;">Name of Adviser/Teacher:</td>
                ...
                @if($record[1]->type == 1)
                    @if(DB::table('schoolinfo')->first()->schoolid == '405308') {{--fmcma--}}
                        <tr style="font-weight: bold; font-size: 9px;">
                            ...
                            <td class="text-center">@if(collect($record[1]->generalaverage)->first()->finalrating > 0){{collect($record[1]->generalaverage)->first()->finalrating >= 75 ? 'PROMOTED' : 'FAILED'}}@endif</td>
                        </tr>
                    @else
                        <tr style="font-weight: bold;font-size: 9px;">
                            <td></td>
                            ...
                            <td class="text-center">
                                @if(isset(collect($record[1]->generalaverage)->first()->finalrating))@if(collect($record[1]->generalaverage)->first()->finalrating > 0){{ collect($record[1]->generalaverage)->first()->finalrating >= 75 ? 'PROMOTED' : 'FAILED'}}@endif @endif
                            </td>
            ...
            <table style="width: 100%; margin-top: 4px; border: 1px solid black; page-break-inside: avoid" border="1">
                <tr>
                ...
                <tr>
                    <td style="padding: 10px 2px 0px; font-size: 11px;">
                        ...
                        Name of School: <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  School ID: <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Last School Year Attended: <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$footer->lastsy ?? ''}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>
                        @else
                        Name of School: <u>{{$attended_lastschool}}</u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  School ID: <u>{{$attended_lastschoolid}}</u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Last School Year Attended: <u>&nbsp;&nbsp;@if(strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'sbc') &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; @else{{$attended_lastschoolyear}}@endif&nbsp;&nbsp;</u>
                        @endif
                        <br/>&nbsp;
                        <br/>&nbsp;
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 30%; border-bottom: 1px solid black; text-align: center;">{{date('M d, Y')}}</td>
                                <td style="width: 5%;"></td>
                                ...
                                <td style="border-bottom: 1px solid black; text-align: center;">
                                    ...
                                    @endphp
                                    @if($principalname)
                                       {{$principalname->firstname}} {{$principalname->middlename != null ? $principalname->middlename[0].'.' : ''}} {{$principalname->lastname}} {{$principalname->suffix}}
                                    @endif</td>
                                @endif
                                <td style="width: 10%;"></td>
                                <td style="width: 20%;"></td>
