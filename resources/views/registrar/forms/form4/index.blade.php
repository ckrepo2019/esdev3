...
@section('content')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Update the year options whenever the S.Y dropdown changes
        ...
        function updateYearOptions() {
            // Get the selected text from the school year dropdown
            var selectedSY = $('#selectedsy option:selected').text();
            var years = selectedSY.split('-'); // Split the S.Y like "2024-2025"

            // Ensure that two years are found in the format of YYYY-YYYY
            if (years.length === 2) {
                var startYear = $.trim(years[0]); // Trim any extra spaces
                var endYear = $.trim(years[1]);

                // Clear the existing options in the year dropdown
                $('#selectedyear').empty();

                // Add the start and end years as options
