        ...
        <div class="card-header">
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-6 text-right">
                    <label>&nbsp;</label><br/>
                    <button type="button" class="btn btn-primary" id="btn-getsetups"><i class="fa fa-sync"></i> Get Setups</button>
                </div>
            </div>
            @else
            <div class="row mb-2">
            ...
            <div class="row" id="setup-container">
                ...
                <div class="col-md-9 text-right">
                    <label>&nbsp;</label><br/>
                    <button type="button" class="btn btn-sm btn-primary" id="btn-generate"><i class="fa fa-sync"></i> Generate SF2</button>
                </div>
            </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','#btn-printpdf', function(){
                ...
                window.open("/forms/form2?action=export&exporttype=pdf&selectedmonth="+monthid+"&selectedyear="+yearid+"&levelid="+levelid+"&sectionid="+sectionid+"&syid="+syid+"&pam_male="+$('#pam_male').text()+"&pam_female="+$('#pam_female').text()+"&pam_total="+$('#pam_total').text()+"&strandid="+strandid+"&semester="+semid+"&selectedlact="+1);
            })
            $(document).on('click', '#btn-printpdf',function(){
