    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-md-8 align-self-end">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approvalperdep" id="btn-approvalperdep" hidden><i class="fa fa-plus"></i> Approval Department</button>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, item) {
                        var row = $('<tr>');
                        row.append('<td><input type="text" class="inputyears" value="'+item.years+'" data-id="'+item.id+'" style="border: none; outline: none;" /></td>');
                        row.append('<td><input type="text" class="inputdays" value="'+item.days+'" data-id="'+item.id+'" style="border: none; outline: none;" /></td>');
