                  ...
                  <div class="col-md-12">
                        <div class="card shadow">
                              <div class="card-body">
                                    <div class="row">
                                          <div class="col-md-12">
                                               <i><p class="mb-0 text-danger" style="font-size:.8rem !important">Status: <span id="status_holder"></span></p></i>
                                          </div>
                                    </div>
                                    <div class="row">
                                          <div class="col-md-3">
      ...
      <script>
            $(document).ready(function(){
                                    ...
                                    $.each(temp_students,function (a,b) {
                                          ...
                                          if(check.length > 0){
                                                ...
                                                if($('#filter_status_by_subject').val() == "drop"){
                                                      ...
                                                      if(check.prelemstatus == 8 || check.midtermstatus == 8 || check.prefistatus == 8 || check.finalstatus == 8){
                                                            include = true
                                                      }
                                                }
                  ...
                  function teacher_sched(){
                        ...
                        $('#filter_status_by_subject').append('<option value="inc" '+inc_checked+'>INC ('+all_teacher_sched.filter(x=>x.inc == true).length+')</option>');
