                              ...
                              columnDefs: [
                                          {
                                                ...
                                                'createdCell':  function (td, cellData, rowData, row, col) {
                                                      var text = '<a class="mb-0">'+rowData.sectionname+'</a><p class="text-muted mb-0" >'+rowData.levelname+'</p>';
                                                      $(td)[0].innerHTML =  text
                                          ...
                                          },
                                          {
                                                ...
                                                'createdCell':  function (td, cellData, rowData, row, col) {
                                                      ...
                                                      var text = '<a class="mb-0">'+rowData.subjdesc+' '+comp+' '+pending+' </a><p class="text-muted mb-0">'+rowData.subjcode+' '+type+'</p>';
                                                      $(td)[0].innerHTML =  text
                                                      $(td).addClass('align-middle')
                                                }
                                          },
                                          {
                                                ...
                                                'createdCell':  function (td, cellData, rowData, row, col) {
                                                      ...
                                                      $.each(rowData.schedule,function(a,b){
                                                            text += '<tr style="background-color:transparent !important" ><td width="100%" class="'+multiple+'">'+b.start + ' - ' + b.end + '<br>'+b.day +'</td></tr>'
                                                      })
                                                      text += '</table>'
                                                      $(td)[0].innerHTML =  text
                                                      $(td).addClass('align-middle')
