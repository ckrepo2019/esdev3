        ...
        <thead>
            <tr >
                ...
                @foreach ($subjects as $subj_item)
                    @if($section_detail->levelid != 14 && $section_detail->levelid != 15)
                        @if($quarter != 5)
							@if(strlen($subj_item->subjdesc) > 25)
								<td class="rotated_cell" style="font-size: 9.5px !important; padding-bottom: 2px">
							@else
                        ...
                        @else
                            @if($subj_item->subjCom == null)
                                @if(strlen($subj_item->subjdesc) > 25)
									<td class="rotated_cell" style="font-size: 9.5px !important; right: 50px">
								@else
									<td class="rotated_cell" >
								@endif
                                    <div class="rotate_text" style="bottom: 20px !important">
                    ...
                    @else
                        @if(strlen($subj_item->subjdesc) > 25)
							<td class="rotated_cell" style="font-size: 9.5px !important; padding-bottom: -6px !important">
						@else
							<td class="rotated_cell" style="padding-bottom:-8px !important">
						@endif
                            <div class="rotate_text" style="bottom: 20px !important">
                                 {{$subj_item->subjdesc}}
                            </div>
