				...
				{{-- <table width="100%"> 
                                    ...
                                    <td width="25%">
                                          <table width="100%">
                                                <tbody>
                                                      ...
                                                      <tr>
                                                            <td style="text-align: right; font-size:11px">{{$activeSem->semester}} SY {{$activeSy->sydesc}}</td>
                                                      </tr>
                                                      <tr>
                        ...
                        <tbody>
                              <tr>
                                    <td width="75%" valign="top">
                                          <table width="100%"  class="table table-bordered mb-0" style="font-size:.5rem !important">
                                                @php  
                                                      $totalUnits = 0.0;
                                                @endphp
                                                <tbody>
                                                      <tr>
														...
														<th class="p-1 text-center">Units</th>
                                                                                    <th class="p-1 text-center">Term</th>
                                                      ...
                                                      @foreach ($schedules as $item)
															...
															<tr>
																  ...
																  <td class="p-1  text-center" width="17%"  >
																		@foreach($item as $timeitem)
																			  @if($timeitem->stime != null && $timeitem->etime != null)
																					<p class="mb-0">{{\Carbon\Carbon::create($item[0]->stime)->isoFormat('hh:mm A')}} - {{\Carbon\Carbon::create($item[0]->etime)->isoFormat('hh:mm A')}}</p>
																			  @else
																					<p class="mb-0"></p>
																			  @endif
																		@endforeach
                                                ...
                                                <tbody>
                                                      @foreach ($ledger as $item)
                                                            <tr  style="vertical-align: top; padding-top: 20px; padding-bottom: 20px;">
                                                                  ...
                                                                  <td style="padding-top: 3px; padding-bottom: 3px; text-align: right;  padding-right: 4px !important;">
                  ...
                  <table style="font-size:10px" width="100%">
                        ...
                        <tr>
                              ...
                              <td width="4%">Php</td>
                              <td style="text-align: right; font-size:13px;" width="8%"><b>{{number_format(collect($ledger)->sum('amount'),2)}}</b></td>
                        </tr>
                        </tbody>
                  </table>
				  <br>
                  <p style="font-size:10px !important">This is your official certificate of registration. Please check and verify thoroughly the correctness of these data. 
                        If you have question or verification on the data found in this report, you may visit the RECORDS AND ADMISSION OFFICE.</p>
				  <br>
                 ...
                 <table style="font-size:10px"  width="100%">
                        <tr >
                              ...
                              <td width="20%" style="text-align: center"> <u>JINGLE A. PADAYAO</u></td>
                                          ...
                                          <table width="100%" >
                                                <tbody>
                                                      ...
                                                      <tr style="vertical-align: top;">
                                                            ...
                                                            <td width="40%">NAME: {{$studentInfo->lastname.', '.$studentInfo->firstname}}</td>
                                                            <td width="30%">CONTACT NO. {{$studentInfo->contactno}}</td>
                                                      </tr>
                                                      <tr>
                                                            <td colspan="3">Course & Year: {{$studentInfo->courseDesc}} {{$studentInfo->levelname}}</td>
