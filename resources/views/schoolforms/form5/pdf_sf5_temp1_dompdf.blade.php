                        ...
                        <table style="width: 100%; font-size: 11px; table-layout: fixed; page-break-inside:always;" border="1">
                            <thead>
                                <tr style="text-align: center; font-size: 10.5px;">
                                    ...
                                    <th style="width: 14%; vertical-align: top;" rowspan="2">GENERAL AVERAGE(Numerical Value in 2 decimal places and 3 decimal places for honor learners, and Descriptive Letter)</th>
                                    <th style="width: 15%;" rowspan="2">ACTION TAKEN: PROMOTED, CONDITIONAL, or RETAINED</th>
                                    <th colspan="2">INCOMPLETE SUBJECT/S (This column is for K to 12 Curriculum and remaining RBEC in High School. Elementary grades level that are still implementing RBEC need not to fill up these columns)</th>
                                </tr>
                                <tr style="text-align: center; line-height: 8px !important;">
                                    <th style="font-size: 8.5px; vertical-align: top;">From previous school years completed as of end of current School Year</th>
                            ...
                            @php
                                $countMale = 0;   
                                $malelineheight = 14;
                                $malecountlimit = strtolower(DB::table('schoolinfo')->first()->abbreviation) != 'bct' ? 25 : 15;
